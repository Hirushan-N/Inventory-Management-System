...
namespace store_001
{
    class My_Report
    {
        ...
        public static DataTable GetSource(DateTime SelectedDate,int SelectedRadio)//////get report by date
        {
        ...
        public static DataTable GetSource(DateTime SelectedDate, string Category,int SelectedRadio)//////get report by category & date
        {
            ...
            for (int i = 0; i < rowcount; i++)
            {
                ...
                string SQL1 = @"Select PRODUCT_ID , PRODUCT_NAME From (Select  Row_Number() Over (Order By PRODUCT_ID) As RowNum , *From INVENTORY) AS NUMBERS WHERE RowNum = '" + i + "' AND CATEGORY = '" + Category + "'";
                SqlCommand com1 = new SqlCommand(SQL1, con);
                SqlDataReader reader1 = com1.ExecuteReader();
                if (reader1.HasRows)
                {
        ...
        public static DataTable GetSource(DateTime SelectedDate ,Label PName,int SelectedRadio)//////get report by productname & date
        {
            int ProductId = 0;
            string ProductName = "";
            decimal TotalQuantity = 0;
            ...
            string SQL1 = @"Select PRODUCT_ID FROM INVENTORY WHERE PRODUCT_NAME = '" + Productname + "'";
            SqlCommand com1 = new SqlCommand(SQL1, con);
            SqlDataReader reader1 = com1.ExecuteReader();
            if (reader1.HasRows)
            {
        ...
        public static Decimal Profit(DateTime SelectedDate, Label PName, int SelectedRadio)//////get profit by productname & date
        {
            DataTable DT = new DataTable();
            SqlConnection con = new SqlConnection(connectDB.connectionstring);
            con.Open();
            ...
            string SQL1 = @"Select PRODUCT_ID , WHOLESALE_PRICE  From INVENTORY WHERE PRODUCT_NAME='" + Productname + "'";
            SqlCommand com1 = new SqlCommand(SQL1, con);
            SqlDataReader reader1 = com1.ExecuteReader();
            if (reader1.HasRows)
            {
        ...
        public static Decimal Profit(DateTime SelectedDate,string Category, int SelectedRadio)//////get report by date & combo
        {
            ...
            for (int i = 0; i <= rowcount; i++)
            {
                ...
                string SQL1 = @"Select PRODUCT_ID , WHOLESALE_PRICE  From (Select  Row_Number() Over (Order By PRODUCT_ID) As RowNum , *From INVENTORY) AS NUMBERS WHERE RowNum = '" + i + "' AND CATEGORY = '"+Category+"'";
                SqlCommand com1 = new SqlCommand(SQL1, con);
                SqlDataReader reader1 = com1.ExecuteReader();
                if (reader1.HasRows)
                {
        ...
        public static int GetProductCount(DateTime SelectedDate, int SelectedRadio)
        {
            ...
            string SQL1 = @"SELECT COUNT(*) FROM ((SOLD_OUT INNER JOIN INVENTORY ON SOLD_OUT.PRODUCT_ID=INVENTORY.PRODUCT_ID) INNER JOIN BILL_DETAILS ON BILL_DETAILS.BILL_ID=SOLD_OUT.BILL_ID )  " + Where_Clause + " GROUP BY INVENTORY.PRODUCT_ID";
            SqlCommand com1 = new SqlCommand(SQL1, con);
            SqlDataReader reader = com1.ExecuteReader();
            if (reader.HasRows)
            {
